  ...
  <main class="py-10">
    ...
    <section class="mx-auto px-4 flex flex-col items-center gap-4 max-w-[650px] mb-40 mt-30 md:mb-80 md:mt-50">
      ...
      <p class="text-center text-lg">
        Construa a versão que você quer ser, <span
          class="inline-block bg-habit-orange p-0.5 font-mono px-1 -skew-x-16 text-white"> um dia de cada vez</span>.
        Acompanhe, visualize e celebre cada pequena vitória.
      </p>

      <a
        href="{{ auth()->check() ? route('habits.index') : route('site.register') }}"
    ...
    <section class="faq max-w-5xl mx-auto flex flex-col gap-8 pt-40 pb-20 px-4">
      ...
      <article class="flex flex-col items-center gap-4 max-w-xl mx-auto">
        <x-question question="Como funciona o registro de hábitos?">
          Você cria seus hábitos personalizados e marca diariamente quando os completa. O sistema registra tudo
          automaticamente e te mostra seu progresso ao longo do tempo de forma visual e clara.
        </x-question>

        <x-question question="Posso rastrear múltiplos hábitos ao mesmo tempo?">
          Sim! Você pode adicionar quantos hábitos quiser e acompanhar todos eles em um único painel. Cada hábito tem
          seu próprio histórico e estatísticas independentes.
        </x-question>

        <x-question question="Como acompanho meu progresso?">
          O sistema gera gráficos e estatísticas automáticas mostrando seus dias completados, taxa de consistência e
          evolução ao longo do tempo. Tudo de forma visual e fácil de entender.
        </x-question>

        <x-question question="Posso personalizar meus hábitos?">
          Totalmente! Você define o nome, descrição e pode ajustar as configurações de cada hábito conforme sua rotina e
          objetivos pessoais.
        </x-question>

        <x-question question="Meus dados ficam salvos?">
          Sim, tudo fica armazenado de forma segura. Você pode acessar seu histórico completo a qualquer momento e
          acompanhar sua jornada de construção de hábitos.
        </x-question>
      </article>
